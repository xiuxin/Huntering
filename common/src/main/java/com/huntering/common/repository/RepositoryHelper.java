...
public class RepositoryHelper {
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[com.huntering.common.repository.RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see com.huntering.common.repository.callback.DefaultSearchCallback}<br/>
     * <p/>
     * 测试用例请参考：{@see com.huntering.common.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see com.huntering.common.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.huntering.common.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.huntering.common.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：com.huntering.common.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see com.huntering.common.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return

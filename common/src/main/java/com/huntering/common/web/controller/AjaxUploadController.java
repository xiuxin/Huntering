 ...
 */
package com.huntering.common.web.controller;

import com.huntering.common.Constants;
import com.huntering.common.utils.ImagesUtils;
...
public class AjaxUploadController {
    ...
    public AjaxUploadResponse ajaxUpload(
        ...
        for (MultipartFile file : files) {
            ...
            try {
                String url = FileUploadUtils.upload(request, baseDir, file, allowedExtension, maxSize, false);

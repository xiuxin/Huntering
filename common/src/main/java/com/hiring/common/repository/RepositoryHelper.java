 ...
 */
package com.hiring.common.repository;

import com.hiring.common.entity.search.Searchable;
import com.hiring.common.repository.callback.SearchCallback;
...
public class RepositoryHelper {
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[com.hiring.common.repository.RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see com.hiring.common.repository.callback.DefaultSearchCallback}<br/>
     * <p/>
     * 测试用例请参考：{@see com.hiring.common.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see com.hiring.common.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.hiring.common.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.hiring.common.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：com.hiring.common.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see com.hiring.common.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return

 ...
 */
package com.hiring.common.entity.search.utils;

import com.google.common.collect.Lists;
import com.hiring.common.entity.search.SearchOperator;
import com.hiring.common.entity.search.Searchable;
import com.hiring.common.entity.search.exception.InvalidSearchPropertyException;
import com.hiring.common.entity.search.exception.InvalidSearchValueException;
import com.hiring.common.entity.search.exception.SearchException;
import com.hiring.common.entity.search.filter.AndCondition;
import com.hiring.common.entity.search.filter.Condition;
import com.hiring.common.entity.search.filter.OrCondition;
...
public final class SearchableConvertUtils {
     ...
     * value="com.hiring.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.hiring.common.entity.search.utils." +

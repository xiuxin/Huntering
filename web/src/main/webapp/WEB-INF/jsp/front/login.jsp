...
<footer class="footer">
    <div class="container">
        ...
        <ul class="footer-links">
            <li class="muted">·</li>
            <li><a href="https://github.com/xiuxin/huntering/issues?state=open" target="_blank">问题反馈</a></li>
            <li class="muted">·</li>
            <li><a href="https://github.com/xiuxin/huntering" target="_blank">项目主页</a></li>
        </ul>
    </div>
</footer>
<es:contentFooter/>

...
import com.huntering.sys.auth.entity.Auth;
import com.huntering.sys.auth.service.AuthService;
...
public class UserAuthCacheAspect extends BaseCacheAspect {
     ...
     * 当删除资源时，清缓存
     */
    @Pointcut(value = "target(com.huntering.sys.resource.service.ResourceService)")
     ...
     * 当删除权限时，清缓存
     */
    @Pointcut(value = "target(com.huntering.sys.permission.service.PermissionService)")
     ...
     * 当修改角色show/role/resourcePermissions关系时，清缓存
     */
    @Pointcut(value = "target(com.huntering.sys.permission.service.RoleService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.huntering.sys.organization.service.OrganizationService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.huntering.sys.organization.service.JobService)")
     ...
     * 当删除组时，清缓存
     */
    @Pointcut(value = "target(com.huntering.sys.group.service.GroupService)")
     ...
     * 其他情况，清所有
     */
    @Pointcut(value = "target(com.huntering.sys.group.service.GroupRelationService)")
    ...
    @Pointcut(value = "target(com.huntering.sys.auth.service.UserAuthService)")
